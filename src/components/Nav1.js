                ...
                {({ open }) => (
                    <>
                        <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                            <div className="relative flex h-16  justify-between">
                                ...
                                <div className="absolute  flex items-center  right-0 inset-y-5  justify-between">
                                    ...
                                    {/* Profile dropdown */}
                                    <Menu as="div" className="relative ml-2 sm:ml-2">
                                        <div>
                        ...
                        <Disclosure.Panel className={classNames(
                            ...
                            <div className="space-y-1 px-3 pb-3 pt-2 flex flex-col justify-center items-center sm:text-center">
                                {navigation.map((item) => (
                                    <Disclosure.Button
                                        key={item.name}
                                        as="a"
                                        ...
                                        className={classNames(
                                            ...
                                            'block rounded-md px-3 py-2 text-base font-medium container'
                                        )}
